    ...
    @if (!empty($factura))
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Actualizar Factura {{$factura->talonario->nro_punto_vta}} - {{$factura->nro_factura}} |  <small>{{$factura->cliente->firstname.' '.$factura->cliente->lastname}}</small> </h2> 
            ...
            <div class="x_content">
              ...
              <form action="/admin/period/bill-update/{{$factura->id}}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
