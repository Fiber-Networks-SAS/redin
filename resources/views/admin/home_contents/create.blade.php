  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Nuevo Contenido para la Página Principal</h2>
              ...
              <div class="form-group {{ $errors->has('section') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="form-control" name="section" id="section" required>
                    ...
                    <option value="slider" {{ old('section') == 'slider' ? 'selected' : '' }}>Slider Principal</option>
                    <option value="services" {{ old('section') == 'services' ? 'selected' : '' }}>Servicios</option>
                    <option value="company" {{ old('section') == 'company' ? 'selected' : '' }}>La Empresa</option>
                    <option value="internet" {{ old('section') == 'internet' ? 'selected' : '' }}>Internet</option>
                    <option value="contact" {{ old('section') == 'contact' ? 'selected' : '' }}>Contacto</option>
                  </select>
              ...
              <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" class="form-control" name="title" id="title"
                         value="{{ old('title') }}" placeholder="Título de la sección">
              ...
              <div class="form-group {{ $errors->has('subtitle') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" class="form-control" name="subtitle" id="subtitle"
                         value="{{ old('subtitle') }}" placeholder="Subtítulo de la sección">
              ...
              <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea class="form-control" name="content" id="content" rows="6"
                            placeholder="Contenido de la sección (puede incluir HTML)">{{ old('content') }}</textarea>
              ...
              <div class="form-group {{ $errors->has('link_text') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" class="form-control" name="link_text" id="link_text"
                         value="{{ old('link_text') }}" placeholder="Ejemplo: Ver más, Contactanos">
              ...
              <div class="form-group {{ $errors->has('link_url') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" class="form-control" name="link_url" id="link_url"
                         value="{{ old('link_url') }}" placeholder="Ejemplo: #contact, /login">
              ...
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button type="submit" class="btn btn-success">
                    <i class="fa fa-save"></i> Crear Contenido
                  </button>
