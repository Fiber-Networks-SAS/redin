  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Editar Bonificación #{{ $bonificacion->id }}</h2>
            <span class="nav navbar-right">
              <a href="/admin/bonificaciones/view/{{ $bonificacion->id }}" class="btn btn-info btn-xs">
                <i class="fa fa-eye"></i> Ver Bonificación
              </a>
          ...
          <div class="x_content">
            <form method="POST" action="/admin/bonificaciones/edit/{{ $bonificacion->id }}" class="form-horizontal form-label-left">
              {{ csrf_field() }}
                  ...
                  <select name="service_id" id="service_id" class="form-control" required>
                    ...
                    @foreach($servicios as $servicio)
                      <option value="{{ $servicio->id }}" 
                              {{ (old('service_id', $bonificacion->service_id) == $servicio->id) ? 'selected' : '' }}>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="number" name="porcentaje_bonificacion" id="porcentaje_bonificacion" 
                         ...
                         value="{{ old('porcentaje_bonificacion', $bonificacion->porcentaje_bonificacion) }}" required
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="number" name="periodos_bonificacion" id="periodos_bonificacion" 
                         ...
                         value="{{ old('periodos_bonificacion', $bonificacion->periodos_bonificacion) }}" required
                         placeholder="Ej: 6">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="date" name="fecha_inicio" id="fecha_inicio" 
                         class="form-control" 
                         value="{{ old('fecha_inicio', $bonificacion->fecha_inicio->format('Y-m-d')) }}" required>
                  ...
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" name="activo" id="activo" value="1" 
                             {{ old('activo', $bonificacion->activo) ? 'checked' : '' }}>
                      Bonificación activa
                    </label>
                  </div>
                  <small class="text-muted">Marque para mantener la bonificación activa</small>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea name="descripcion" id="descripcion" class="form-control" 
                            rows="3" placeholder="Descripción opcional de la bonificación">{{ old('descripcion', $bonificacion->descripcion) }}</textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button type="submit" class="btn btn-success">
                    <i class="fa fa-save"></i> Actualizar Bonificación
                  </button>
                  <a href="/admin/bonificaciones/view/{{ $bonificacion->id }}" class="btn btn-info">
