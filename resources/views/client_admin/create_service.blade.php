            ...
            <br />
              ...
              <form action="/admin/clients/services/create" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="costo_instalacion" name="costo_instalacion" costo_instalacion_base="" class="form-control col-md-7 col-xs-12 @if ($errors->has('costo_instalacion')) parsley-error @endif" value="{{ old('costo_instalacion') ? old('costo_instalacion') : '' }}">
