          ...
          <div class="x_content">
            <br />
              ...
              <form action="/admin/clients/services/create" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="alta_servicio">Fecha de Alta<span class="required">*</span></label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="alta_servicio" name="alta_servicio" class="form-control col-md-7 col-xs-12 @if ($errors->has('alta_servicio')) parsley-error @endif" value="{{ old('alta_servicio') ? old('alta_servicio') : '' }}"  placeholder="dd/mm/aaaa" data-inputmask="'mask': '99/99/9999'" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="costo_instalacion" name="costo_instalacion" costo_instalacion_base="" class="form-control col-md-7 col-xs-12 @if ($errors->has('costo_instalacion')) parsley-error @endif" value="{{ old('costo_instalacion') ? old('costo_instalacion') : '' }}" readonly>
