        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
              ...
              <form action="/admin/clients/payment_plan/create" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 container-name">
                    <input type="text" id="autocomplete-client-name" name="name" class="form-control col-md-7 col-xs-12 @if ($errors->has('name')) parsley-error @endif" value="{{ old('name') ? old('name') : $user->firstname . ' '. $user->lastname }}"  required readonly>
                    <input type="hidden" id="user_id" name="user_id" value="{{ old('user_id') ? old('user_id') : $user->id }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="pp_cuotas_adeudadas" name="pp_cuotas_adeudadas" class="form-control col-md-7 col-xs-12 @if ($errors->has('pp_cuotas_adeudadas')) parsley-error @endif" value="{{ old('pp_cuotas_adeudadas') ? old('pp_cuotas_adeudadas') : '' }}" required>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <select class="form-control" id="deuda_instalacion" name="deuda_instalacion">
                        @for ($i = 0; $i <= 100; $i = $i + 25)
                          <option value="{{$i}}" {{ old('deuda_instalacion') == $i ? 'selected' : '' }}>{{$i}}%</option>
                        @endfor
                      </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="hidden" id="hidden_total_deuda" name="hidden_total_deuda" value="{{ old('hidden_total_deuda') ? old('hidden_total_deuda') : '' }}">
                    <input type="text" id="total_deuda" name="total_deuda" class="form-control col-md-7 col-xs-12 @if ($errors->has('total_deuda')) parsley-error @endif" value="{{ old('total_deuda') ? old('total_deuda') : '' }}" required readonly>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="input-group">
                      ...
                      <input type="text" id="abono_mensual_pagar" name="abono_mensual_pagar" class="form-control col-md-7 col-xs-12 @if ($errors->has('abono_mensual_pagar')) parsley-error @endif" value="{{ old('abono_mensual_pagar') ? old('abono_mensual_pagar') : '' }}" requireds readonly>
