        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            @if (!empty($servicio))
              ...
              <form action="/admin/clients/services/edit/{{$servicio->id}}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="contrato_nro" name="contrato_nro" class="form-control col-md-7 col-xs-12 @if ($errors->has('contrato_nro')) parsley-error @endif" value="{{ old('contrato_nro') ? old('contrato_nro') : $servicio->contrato_nro }}" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="contrato_fecha" name="contrato_fecha" class="form-control col-md-7 col-xs-12 @if ($errors->has('contrato_fecha')) parsley-error @endif" value="{{ old('contrato_fecha') ? old('contrato_fecha') : $servicio->contrato_fecha }}"  placeholder="dd/mm/aaaa" data-inputmask="'mask': '99/99/9999'" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="alta_servicio" name="alta_servicio" class="form-control col-md-7 col-xs-12 @if ($errors->has('alta_servicio')) parsley-error @endif" value="{{ old('alta_servicio') ? old('alta_servicio') : $servicio->alta_servicio }}"  placeholder="dd/mm/aaaa" data-inputmask="'mask': '99/99/9999'">
                ...
                <!-- <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <select class="form-control" name="mes_alta" required>
                        ...
                        @for ($i = 1; $i <= 12; $i++)
                          <option value="{{$i}}" {{ old('mes_alta') == $i || $servicio->mes_alta == $i ? 'selected' : '' }}>{{$i < 10 ? "0" . $i : $i}}</option>
                        @endfor
                      </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="costo_instalacion" name="costo_instalacion" costo_instalacion_base="{{$servicio->costo_instalacion_base}}" class="form-control col-md-7 col-xs-12 @if ($errors->has('costo_instalacion')) parsley-error @endif" value="{{ old('costo_instalacion') ? old('costo_instalacion') : $servicio->costo_instalacion }}">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <select class="form-control" name="plan_pago">
                        ...
                        @foreach ($cuotas as $cuota)
                          ...
                          <option value="{{$cuota->id}}" tasa="{{$cuota->interes}}" {{ old('plan_pago') == $cuota->id || $servicio->plan_pago == $cuota->id ? 'selected' : '' }}>{{$label_opt}}</option>
                ...
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <a href="/admin/clients/services/{{$user->id}}" class="btn btn-primary">Cancelar</a>
