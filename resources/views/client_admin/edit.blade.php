            ...
            @if (!empty($user))
              ...
              <form action="/admin/clients/edit/{{$user->id}}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                ...
                <h4>Datos Personales</h4>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="nro_cliente" name="nro_cliente" class="form-control col-md-7 col-xs-12 @if ($errors->has('nro_cliente')) parsley-error @endif" value="{{ old('nro_cliente') ? old('nro_cliente') : $user->nro_cliente }}" required >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="barrio" name="barrio" class="form-control col-md-7 col-xs-12 @if ($errors->has('barrio')) parsley-error @endif" value="{{ old('barrio') ? old('barrio') :  $user->barrio }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="altura" name="altura" class="form-control col-md-7 col-xs-12 @if ($errors->has('altura')) parsley-error @endif" value="{{ old('altura') ? old('altura') :  $user->altura }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="manzana" name="manzana" class="form-control col-md-7 col-xs-12 @if ($errors->has('manzana')) parsley-error @endif" value="{{ old('manzana') ? old('manzana') :  $user->manzana }}">
                    ...
                    @if(count($provincias))
                        <select class="form-control" name="provincia" required>
                            @foreach($provincias as $provincia)
                                <option value="{{$provincia->id}}" {{ $user->provincia ==  $provincia->id || old('provincia') == $provincia->id ? 'selected' : '' }}>{{$provincia->nombre}}</option>
                            @endforeach
                        </select>
                    @else
                    ...
                    @if(count($localidades))
                        <select class="form-control" name="localidad" required>
                            @foreach($localidades as $localidad)
                                <option value="{{$localidad->id}}" {{ $user->localidad ==  $localidad->id || old('localidad') == $localidad->id ? 'selected' : '' }}>{{$localidad->nombre}}</option>
                            @endforeach
                        </select>
                    @else
                        <div class="alert alert-danger">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="cp" name="cp" class="form-control col-md-7 col-xs-12 @if ($errors->has('cp')) parsley-error @endif" value="{{ old('cp') ? old('cp') : $user->cp }}">
                    ...
                    @if(count($talonarios))
                        <select class="form-control" name="talonario_id" required>
                            @foreach($talonarios as $talonario)
                                <option value="{{$talonario->id}}" data-letra="{{$talonario->letra}}" {{ $user->talonario_id ==  $talonario->id || old('talonario_id') == $talonario->id ? 'selected' : '' }}>{{$talonario->nombre}}</option>
                            @endforeach
                        </select>
                    @else
                        <div class="alert alert-danger">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <select class="form-control" name="drop" required>
                        <option value="0" {{ old('drop') == '0' || $user->drop == 0 ? 'selected' : '' }}>En Pilar</option>
                        <option value="1" {{ old('drop') == 1 || $user->drop == 1 ? 'selected' : '' }}>En Domicilio</option>
                        <option value="2" {{ old('drop') == 2 || $user->drop == 2 ? 'selected' : '' }}>Sin Drop</option>
                      </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="firma_contrato" name="firma_contrato" class="form-control col-md-7 col-xs-12 @if ($errors->has('firma_contrato')) parsley-error @endif" value="{{ old('firma_contrato') ? old('firma_contrato') : $user->firma_contrato }}"  placeholder="dd/mm/aaaa" data-inputmask="'mask': '99/99/9999'">
                ...
                <!-- <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">  
                    <div class="radio">
                      <label>
                        <input type="radio" class="flat" value="1" {{ $user->ont_instalado == '1' ? 'checked' : '' }} name="ont_instalado"> Si
                      </label>
                      <label>
                        <input type="radio" class="flat" value="0" {{ $user->ont_instalado == '0' ? 'checked' : '' }} name="ont_instalado"> No
                      </label>
                    </div>
                  </div>
                </div> -->
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ont_instalado">ONT Instalado</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="ont_instalado" name="ont_instalado" class="form-control col-md-7 col-xs-12 @if ($errors->has('ont_instalado')) parsley-error @endif" value="{{ old('ont_instalado') ? old('ont_instalado') : $user->ont_instalado }}"  placeholder="dd/mm/aaaa" data-inputmask="'mask': '99/99/9999'">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="ont_funcionando" name="ont_funcionando" class="form-control col-md-7 col-xs-12 @if ($errors->has('ont_funcionando')) parsley-error @endif" value="{{ old('ont_funcionando') ? old('ont_funcionando') : $user->ont_funcionando }}"  placeholder="dd/mm/aaaa" data-inputmask="'mask': '99/99/9999'">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="ont_serie1" name="ont_serie1" class="form-control col-md-7 col-xs-12 @if ($errors->has('ont_serie1')) parsley-error @endif" value="{{ old('ont_serie1') ? old('ont_serie1') : $user->ont_serie1 }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="ont_serie2" name="ont_serie2" class="form-control col-md-7 col-xs-12 @if ($errors->has('ont_serie2')) parsley-error @endif" value="{{ old('ont_serie2') ? old('ont_serie2') : $user->ont_serie2 }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="spliter_serie" name="spliter_serie" class="form-control col-md-7 col-xs-12 @if ($errors->has('spliter_serie')) parsley-error @endif" value="{{ old('spliter_serie') ? old('spliter_serie') : $user->spliter_serie }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="autocomplete-user-name" name="name" class="form-control col-md-7 col-xs-12 @if ($errors->has('name')) parsley-error @endif" value="{{ old('name') ? old('name') : ( $user->instalador ? $user->instalador->firstname . ' ' . $user->instalador->lastname : '') }}">
                    <input type="hidden" id="instalador_id" name="instalador_id" value="{{ old('instalador_id') ? old('instalador_id') : $user->instalador_id }}">
