        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <ul class="messages">
              ...
              <li>
                ...
                <div class="message_wrapper">
                  <h4 class="heading">{{ $reclamo->usuario->firstname.' '.$reclamo->usuario->lastname }}</h4>
            ...
            @if (!empty($reclamo))
              ...
              <form action="/my-claims/reply/{{$reclamo->id}}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    @if($reclamo->status == 0)
                      <a href="/my-claims/close/{{$reclamo->id}}" class="btn btn-dark">Cerrar</a>
                    @endif
                  </div>
                </div>
