      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <span class="nav navbar-right">
              <a href="/admin/clients/services/create" class="btn btn-warning btn-xs"><i class="fa fa-cubes"></i> Asignar Servicios</a>
            	<a href="/admin/services/create" class="btn btn-info btn-xs"><i class="fa fa-plus-square-o"></i> Nuevo</a>
            </span>
            <div class="clearfix"></div>
          </div>
          ...
          <div class="x_content">
      			...
      			<table id="dataTableServices" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Nombre</th>
