              ...
              <form action="/admin/balance/detail/search" id="balanceDetalleSearchForm" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 container-date-from">
                    <input type="text" id="periodo_from" name="periodo_from" class="form-control col-md-7 col-xs-12 @if ($errors->has('periodo_from')) parsley-error @endif" value="{{ old('periodo_from') ? old('periodo_from') : '' }}"  placeholder="mm/aaaa" data-inputmask="'mask': '99/9999'">
                    @if ($errors->has('periodo_from')) <ul class="parsley-errors-list filled"><li class="parsley">{{ $errors->first('periodo_from') }}</li></ul> @endif
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 container-date-to">
                    <input type="text" id="periodo_to" name="periodo_to" class="form-control col-md-7 col-xs-12 @if ($errors->has('periodo_to')) parsley-error @endif" value="{{ old('periodo_to') ? old('periodo_to') : '' }}"  placeholder="mm/aaaa" data-inputmask="'mask': '99/9999'">
