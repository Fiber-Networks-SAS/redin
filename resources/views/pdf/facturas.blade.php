    ...
    <div class="header">
        ...
        <div class="row">
            ...
            <div class="info_empresa">
                ...
                <p>CAE: {{ $factura->cae }}</p>
                <p class="mp_leyenda">Paga tu factura con Mercado Pago</p>
            ...
            <div class="info_factura">
                ...
                <p><strong>{{ strtoupper($factura->cliente->firstname . ' ' . $factura->cliente->lastname) }}</strong>
                </p>
                <p>Nro. Cliente: {{ $factura->nro_cliente }}</p>
                <p>DNI/CUIT: {{ $factura->cliente->dni }}</p>
                <p>Domicilio: Calle
                    {{ $factura->cliente->calle . ' ' . $factura->cliente->altura . ' - Mz.' . $factura->cliente->manzana }}
                </p>
        ...
        <div class="row">
            <div class="cod_barras">
                <div class="mp_pago">
                    <img src="{{ public_path('logo_meli.png') }}" alt="Logo Mercado Pago" class="mp_img">
                </div>
            </div>
        ...
        <div class="info">
            <div class="mensaje">
                ...
                <ul>
                    ...
                    <li>De cada item en la presente factura se ha discriminado el IVA para preservar la transparencia
                        fiscal.</li>
                </ul>
