                ...
                \Excel::create($filename, function($excel) use($response) {
                    ...
                    $excel->sheet('Balance', function($sheet) use($response) {
                        ...
                        foreach ($response as $key => $periodo):
                            ...
                            $sheet->appendRow(array(
                                $periodo['periodo'],
                                $periodo['facturas_total'],
                                $periodo['facturas_pagadas'],
                                $periodo['facturas_adeudadas'], 
                                $periodo['importe_facturado'], 
                                $periodo['importe_pagado']
                            ));
                        ...
                        $sheet->appendRow(array(
                            ...
                            $footer_importe_facturado,
                            $footer_importe_pagado
                        )); 
                    });
